table 70370 "Excel Buffer Extension"
{
    ...
    var
        ...
        TempInfoExcelBuf: Record "Excel Buffer Extension" temporary;
    ...
    procedure WriteAllToCurrentSheet(var ExcelBuffer: Record "Excel Buffer Extension")
    var
    ...
    procedure WriteCellValue(ExcelBuffer: Record "Excel Buffer Extension")
    var
    ...
    procedure WriteCellFormula(ExcelBuffer: Record "Excel Buffer Extension")
    var
        Decorator: DotNet CellDecorator;
    begin
        with ExcelBuffer do begin
    ...
    var
        TempExcelBuf: Record "Excel Buffer Extension" temporary;
        ToxlRowID: Text[10];
    begin
    ...
    procedure ExportBudgetFilterToFormula(var ExcelBuf: Record "Excel Buffer Extension"): Boolean
    var
        TempExcelBufFormula: Record "Excel Buffer Extension" temporary;
        TempExcelBufFormula2: Record "Excel Buffer Extension" temporary;
        FirstRow: Integer;
        LastRow: Integer;
    ...
    local procedure AddColumnToBuffer(var ExcelBuffer: Record "Excel Buffer Extension"; Value: Variant; IsFormula: Boolean; CommentText: Text; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean; NumFormat: Text[30]; CellType: Option)
    begin
    ...
    procedure EnterCell(var ExcelBuffer: Record "Excel Buffer Extension"; RowNo: Integer; ColumnNo: Integer; Value: Variant; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean)
    begin
        ExcelBuffer.Init();
    ...
    var
        DummyExcelBuf: Record "Excel Buffer Extension";
    begin
    ...
    local procedure OnAfterAddColumnToBuffer(var ExcelBuffer: Record "Excel Buffer Extension"; Value: Variant; IsFormula: Boolean; CommentText: Text; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean; NumFormat: Text[30]; CellType: Option)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeParseCellValue(var ExcelBuffer: Record "Excel Buffer Extension"; var Value: Text; var FormatString: Text; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnWriteCellValueOnBeforeSetCellValue(var ExcelBuffer: Record "Excel Buffer Extension"; var CellTextValue: Text)
    begin
    end;
}